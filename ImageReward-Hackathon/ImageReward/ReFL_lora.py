        ...
        for epoch in range(first_epoch, args.num_train_epochs):
            ...
            for step, batch in enumerate(self.train_dataloader):
                ...
                with self.accelerator.accumulate(self.unet):
                    ...
                    for i, t in enumerate(timesteps[mid_timestep+1:]):
                        with torch.no_grad():
                    ...
                    latents = self.noise_scheduler.scale_model_input(latents, timesteps[mid_timestep])
                    noise_pred = self.unet(
                        latents,
                    ...
                    pred_original_sample = self.noise_scheduler.step(noise_pred, timesteps[mid_timestep], origin_latents).pred_original_sample.to(self.weight_dtype)
